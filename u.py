...
# соответствующий HTML-тег перед отправкой боту. Полный список тегов —
# по официальной документации Telegram Bot API, раздел про Rich Message
# formatting (core.telegram.org/bots/api#rich-message-formatting-options):
# заголовки h1-h6, блочные blockquote/pre, инлайновые b/i/u/s/code.
# (h3 — единственный, который реально проверен вживую; остальные — та же
# схема форматирования, должны работать симметрично.)
RICH_STYLE_TAGS = {
    'sh1': None,
    'sh2': 'h3',
    'sh3': 'h1',
...
async def cmd_help(event):
    ...
    text = (
        ...
        "  .sh2               шрифт h3   (заголовок, проверено)\n"
        "  .sh3               шрифт h1   (заголовок)\n"
        "  .sh4               шрифт h2   (заголовок)\n"
        "  .sh5               шрифт h4   (заголовок)\n"
        "  .sh6               шрифт h5   (заголовок)\n"
        "  .sh7               шрифт h6   (заголовок)\n"
        "  .sh8               цитата     (blockquote)\n"
        "  .sh9               моноширинный блок (pre)\n"
        "  .sh10              жирный     (b)\n"
        "  .sh11              курсив     (i)\n"
        "  .sh12              подчёркнутый (u)\n"
        "  .sh13              зачёркнутый  (s)\n"
